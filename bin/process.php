<?php
$logFile = dirname(__FILE__) . '/process_log';
file_put_contents($logFile, "start process \n", FILE_APPEND);

$filepath = fgets(STDIN);
// $filepath = 'C:\Develop\www\workspace\mms\src\uploads\test\000000_1.MOV';
...
try {
    ...
    file_put_contents($logFile, print_r($asset, true), FILE_APPEND);
    ...
    file_put_contents($logFile, print_r($accessPolicy ,true), FILE_APPEND);
    ...
    file_put_contents($logFile, print_r($locator ,true), FILE_APPEND);
...
file_put_contents($logFile, "end process \n", FILE_APPEND);
